...
public class DuplicateCounter
{
    ...
    {
        HashSet<int> seen = new HashSet<int>();       // Tracks unique items
        HashSet<int> duplicates = new HashSet<int>(); // Tracks items that appear more than once
        ...
        return duplicates.Count; // Number of unique duplicates
    }
}
